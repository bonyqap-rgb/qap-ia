    ...
    <MarketingLayout>
      ...
      <LegalBody>
        <LegalSection title="1. Objeto">
          <p>
            O QAP IA disponibiliza um assistente de apoio à pesquisa jurídica e administrativa, além
            de ferramentas de gestão de documentos e base de conhecimento.
          </p>
        </LegalSection>

        <LegalSection title="2. Caráter informativo">
          <p>
            As respostas geradas têm caráter informativo e de apoio. Elas não constituem parecer
            jurídico, decisão administrativa ou orientação definitiva. Toda informação deve ser
            conferida na legislação vigente antes de qualquer decisão.
          </p>
        </LegalSection>
        ...
        <LegalSection title="5. Conteúdo enviado">
          <p>
            Você mantém a titularidade dos documentos enviados. Concede ao QAP IA licença limitada
            para processar e indexar esse conteúdo com a finalidade exclusiva de prestar o serviço.
          </p>
        </LegalSection>

        <LegalSection title="6. Planos e pagamentos">
          <p>
            Os planos são contratados conforme as condições apresentadas na página de{" "}
            <Link to="/pricing" className="text-azure hover:underline">
              Planos
            </Link>
        ...
        <LegalSection title="7. Disponibilidade">
          <p>
            Empregamos esforços para manter o serviço disponível, mas podem ocorrer interrupções
            para manutenção, atualização ou por fatores externos.
          </p>
        </LegalSection>

        <LegalSection title="8. Limitação de responsabilidade">
          <p>
            O QAP IA não se responsabiliza por decisões tomadas exclusivamente com base nas
            respostas do assistente sem a devida conferência na legislação oficial.
          </p>
        </LegalSection>

        <LegalSection title="9. Encerramento">
          <p>
            A conta pode ser encerrada por solicitação do usuário ou em caso de violação destes
            termos.
          </p>
        </LegalSection>
        ...
        <LegalSection title="10. Foro e contato">
          <p>
            ...
            página de{" "}
            <Link to="/contact" className="text-azure hover:underline">
              Contato
            </Link>
            .
          </p>
